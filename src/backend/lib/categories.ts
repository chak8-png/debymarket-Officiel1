...
export const CATEGORY_LIST: Category[] = [
  ...
  // ── Univers 4 : Jouets et jeux ──────────────────────────────────────
  row(23, "jouets-jeux", "Jouets et jeux", 0, "🧸", null, 4),
  ...
  // ── Univers 5 : Produit érotique (section adulte 18+) ────────────────
  row(17, "produit-erotique", "Produit érotique", 0, "🔞", null, 5),
